...
mass_signatures = [
# isotopes
(1.00335, 'C isotope', {'(C12)': -1, '(C13)': 1}),
(1.9958, 'S isotope', {'(S32)': -1, '(S34)': 1}),
(1.99705, 'Cl isotope', {'(Cl35)': -1, '(Cl37)': 1}),
(1.99795, 'Br isotope', {'(Br79)': -1, '(Br81)': 1}),
(2.00425, 'O isotope', {'(O16)': -1, '(O18)': 1}),
(0.99703, 'N isotope', {'(N14)': -1, '(N15)': 1}),
#
